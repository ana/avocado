...
class Cpu(Test):
    ...
    def test_s390x_cpu_online(self):
        with unittest.mock.patch('afutils.cpu.platform.machine',
                                 return_value='s390x'):
    ...
    def test_s390x_get_family(self):
        with unittest.mock.patch('afutils.cpu.get_arch',
                                 return_value='s390'):
            with unittest.mock.patch('afutils.cpu.get_version',
                                     return_value='8561'):
    ...
    def test_intel_get_family(self):
        with unittest.mock.patch('afutils.cpu.get_arch',
                                 return_value='x86_64'):
            with unittest.mock.patch('afutils.cpu.get_vendor',
                                     return_value='intel'):
                with unittest.mock.patch(
                        'builtins.open',
    ...
    def test_power9_get_family(self):
        with unittest.mock.patch('afutils.cpu.get_arch', return_value='powerpc'):
            with unittest.mock.patch('builtins.open',
                                     return_value=self._get_data_mock('power9')):
    ...
    def test_get_idle_state_off(self):
        retval = {0: {0: False}}
        with unittest.mock.patch('afutils.cpu.online_list',
                                 return_value=[0]):
    ...
    def test_set_idle_state_disable(self):
        output = io.BytesIO()
        function = 'afutils.cpu.online_list'
